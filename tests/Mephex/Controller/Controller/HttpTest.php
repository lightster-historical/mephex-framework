...
class Mephex_Controller_Controller_HttpTest
extends Mephex_Test_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->_controller	= new Stub_Mephex_Controller_Controller_Http();
	}
	
	
	
	/**
	 * @covers Mephex_Controller_Controller_Http::__construct
	 */
	public function testHttpControllerExtendsActionController()
	{
		$this->assertTrue($this->_controller instanceof Mephex_Controller_Controller);
	}
	
	
	
	/**
	 * @covers Mephex_Controller_Controller_Http::getHttpConnectionInfo
	 */
	...
	/**
	 * @covers Mephex_Controller_Controller_Http::getPostRequest
	 */
	...
	/**
	 * @covers Mephex_Controller_Controller_Http::getGetRequest
	 */
