...
class Mephex_Controller_Controller_Exception_ActionNotAccessibleTest
extends Mephex_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_exception	= new Mephex_Controller_Controller_Exception_ActionNotAccessible
		(
			$this->_controller, 
			$this->_method_name, 
			$this->_action_name
    ...
    /**
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::__construct 
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::getController 
     */
    ...
    /**
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::__construct
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::getMethodName 
     */
    ...
    /**
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::__construct
	 * @covers Mephex_Controller_Controller_Exception_ActionNotAccessible::getActionName 
     */
