...
class Mephex_Model_Accessor_Writer_EntityTest
extends Mephex_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_accessor		= new Stub_Mephex_Model_Accessor_Writer_Entity
		(
			$this->_group,
			$this->_mapper,
			$this->_cache,
	...
	public function testGenerateDataReturnsMappedData()
	{
		$parent		= new Stub_Mephex_Model_Entity();
		$parent->setId(5);
		...
		$data		= $this->_accessor->generateData($entity);
		
		$this->assertEquals(1,			$data['id']);
		$this->assertEquals('test',		$data['name']);
		$this->assertEquals(5,			$data['parentId']);
	}
