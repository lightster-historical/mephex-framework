...
class Mephex_Model_Entity_Accessor_Exception_UnknownWriterTest
extends Mephex_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_exception		= new Mephex_Model_Accessor_Exception_UnknownWriter($this->_group, $this->_accessor_name);
	}
