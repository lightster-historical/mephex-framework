...
class Mephex_Model_Entity_Accessor_Exception_UnknownEntityCacheTest
extends Mephex_Test_TestCase
{
	...
	public function setUp()
	{
		...
		$this->_exception	= new Mephex_Model_Accessor_Exception_UnknownEntityCache($this->_group, $this->_class_name);
	}
