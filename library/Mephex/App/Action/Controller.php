...
abstract class Mephex_App_Action_Controller
{
	 ...
	 * @return void
	 * @throws Mephex_App_Action_Controller_Exception_ActionNotFound
	 * @throws Mephex_App_Action_Controller_Exception_ActionNotAccessible
	 */
	protected function processAction($action_name)
	{
		...
		{
			throw new Mephex_App_Action_Controller_Exception_ActionNotFound($this, $method_name, $action_name);
		}
		else if(!is_callable(array($this, $method_name)))
		{
			throw new Mephex_App_Action_Controller_Exception_ActionNotAccessible($this, $method_name, $action_name);
		}
